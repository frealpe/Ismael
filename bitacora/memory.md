# memory.md — Trampas y convenciones no evidentes al trabajar aquí
...
>
> - contexto de negocio o decisiones de producto → `—`
> - principios y decisiones grandes → `design.md`
> - proceso y reglas de sesión → `guia-agente.md`
> - **el trabajo en curso, su alcance o lo que falta por entregar** → `handover.md`
> - **dónde estamos y el próximo paso** → `latest.md`
>
> Para eso, apunta.
>
> **Por qué esas dos, y no es una advertencia teórica.** `handover.md` y `latest.md` **se podan**;
...
<!-- ARRANCA VACÍO Y ESO ESTÁ BIEN.
     ...
     `memory.md` vacío el primer día es correcto y significa exactamente lo que parece.
